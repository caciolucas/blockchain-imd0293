...
Essa atividade encerra o projeto de desenvolvimento de nosso blockchain privado. A entrega será realizada no Google Classroom mas a avaliação será feita no formato de apresentação _online_ ao professor, no dia **25/03/2021, das 17:00 as 18:30**. O trabalho deve ser desenvolvido **individualmente ou em dupla**. Plágios não serão tolerados, resultando em nota zero para todos os envolvidos.
